#ifndef AUTHENTICATION_HANDLER_FACTORY_H
#define AUTHENTICATION_HANDLER_FACTORY_H
 ...
 *  In this class, the return point points to an authentication handler.
 *
 */
class authentication_handler_factory : public request_handler_factory
{
  public:
    authentication_handler_factory(std::string location, path root_file_path);
