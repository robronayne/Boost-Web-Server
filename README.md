...
- ngineers: top-level root of repository
...
# Building the Code
1. At the top level ngineers directory, create a build directory by using command `mkdir build`.
...
1. Navigate to the `ngineers` directory.
